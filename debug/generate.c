...
{
	t_material	*mirror_sp;

	mirror_sp = material_init_with_param(vec(128, 24, 24), vec(600, 0.9, 2.0),
			0);
	mirror_sp->mirror = true;
...
void	setup_camera(t_objects *objects, t_sys *sys)
{
...
void	setup_lights(t_objects *objects, t_sys *sys)
{
